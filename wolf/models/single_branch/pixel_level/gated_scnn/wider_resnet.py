    ...
    def __init__(self,
        ...
        for mod_id, num in enumerate(structure):
            ...
            for block_id in range(num):
                blocks.append((
                    "block%d" % (block_id + 1), IdentityResidualBlock(in_channels, channels[mod_id], norm_act=norm_act)
                ))
    ...
    def __init__(self,
        ...
        for mod_id, num in enumerate(structure):
            ...
            for block_id in range(num):
                ...
                if mod_id == 4:
                    drop = partial(dropout, p=0.3)
                elif mod_id == 5:
                    drop = partial(dropout, p=0.5)
                else:
                    drop = None
...
wider_resnet_16 = partial(WiderResNet, structure=[1, 1, 1, 1, 1, 1])
wider_resnet_20 = partial(WiderResNet, structure=[1, 1, 1, 3, 1, 1])
wider_resnet_38 = partial(WiderResNet, structure=[3, 3, 6, 3, 1, 1])
wider_resnet16_a2 = partial(WiderResNetA2, structure=[1, 1, 1, 1, 1, 1])
wider_resnet20_a2 = partial(WiderResNetA2, structure=[1, 1, 1, 3, 1, 1])
wider_resnet38_a2 = partial(WiderResNetA2, structure=[3, 3, 6, 3, 1, 1])
